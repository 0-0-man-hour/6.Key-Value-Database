...
public class KeyController {
    ...
    public Mono<DataObject> get(@PathVariable String key) {
        ...
        return keyUseCase.intermediateGetData(HashKey.builder().key(key).build());
    }
    ...
    public Mono<Boolean> put(@RequestBody DataObject dataObject) {
        ...
        return keyUseCase.intermediateSaveData(dataObject);
    }
    ...
    public Mono<Boolean> putReplica(@RequestBody DataObject dataObject) {
        ...
        return keyUseCase.saveData(key, dataObject).thenReturn(true);
    }
